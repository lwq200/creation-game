...
const books = [
  {
    ...
    items: [
      ...
      { text: '本册蓝图 v0.1', link: '/册01-逻辑与数/蓝图_v0.1' },
    ],
  },
  {
    text: '📘 册02 · 实数极限与连续',
    collapsed: true,
    items: [
      { text: '册概览', link: '/册02-实数极限与连续/README' },
      ...
      { text: '本册蓝图 v0.1', link: '/册02-实数极限与连续/蓝图_v0.1' },
    ],
  },
  {
    text: '📘 册03 · 单变量微积分',
    collapsed: true,
    items: [
      { text: '册概览', link: '/册03-单变量微积分/README' },
      ...
      { text: '本册蓝图 v0.1', link: '/册03-单变量微积分/蓝图_v0.1' },
    ],
  },
  {
    text: '📘 册04 · 线性代数',
    ...
    items: [
      ...
      { text: '本册蓝图 v0.1', link: '/册04-线性代数/蓝图_v0.1' },
    ],
  },
  {
    text: '📘 册05 · 多元微积分与凸优化',
    collapsed: true,
    items: [
      { text: '册概览', link: '/册05-多元微积分与凸优化/README' },
      ...
      { text: '本册蓝图 v0.1', link: '/册05-多元微积分与凸优化/蓝图_v0.1' },
    ],
  },
  {
    text: '📘 册06 · 概率统计与信息',
    collapsed: true,
    items: [
      { text: '册概览', link: '/册06-概率统计与信息/README' },
      ...
      { text: '本册蓝图 v0.1', link: '/册06-概率统计与信息/蓝图_v0.1' },
    ],
  },
  {
    text: '📘 册07 · 图论与可计算性（规划中）',
    collapsed: true,
    items: [
      { text: '本册蓝图 v0.1', link: '/册07-图论与可计算性/蓝图_v0.1' },
    ],
  },
]
...
export default defineConfig({
  lang: 'zh-CN',
  title: '数学基础 · 苏格拉底对话体自学教材',
  description: '《数学基础》系列 7 册：从零推导、可复写证明、计算训练场 —— 造物主与老谟的苏格拉底对话体自学教材',
  base: '/creation-game/',
  cleanUrls: true,
  lastUpdated: true,
  ...
  themeConfig: {
    logo: '/creation-game/logo.svg',
    siteTitle: '数学基础系列',
    nav: [
      { text: '首页', link: '/' },
      { text: '丛书蓝图', link: '/丛书蓝图_v0.1' },
      { text: '册01 · 逻辑与数', link: '/册01-逻辑与数/README' },
      { text: '册02 · 实数极限与连续', link: '/册02-实数极限与连续/README' },
      { text: '册03 · 单变量微积分', link: '/册03-单变量微积分/README' },
      { text: '册04 · 线性代数', link: '/册04-线性代数/README' },
      { text: '册05 · 多元微积分与凸优化', link: '/册05-多元微积分与凸优化/README' },
      { text: '册06 · 概率统计与信息', link: '/册06-概率统计与信息/README' },
    ],
    ...
    sidebar: [
      {
        ...
        items: [
          { text: '🏠 首页', link: '/' },
          { text: '🗺️ 丛书蓝图 v0.1', link: '/丛书蓝图_v0.1' },
        ],
      },
      ...books,
    ],
